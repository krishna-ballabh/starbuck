...
function Aboutus(){
    ...
    return (
        <div className = "pt-12 pb-12 pl-4 text-base md:flex ">
            <div className = "flex justify-between pt-6 pr-4 md:flex md:flex-col">
            ...
            <div className = "flex justify-between pt-6 pr-4 md:pl-6 md:flex md:flex-col">
