            ...
            <div class = "block bg-primary-800 ">
                <div class = "bock m-auto max-w-screen-xl pl-6 pr-6 pt-20 pb-20">
                    <div class = "block pb-10 mb-6 text-center">
                        <h2 class = "text-lg md:text-2xl pt- font-semibold pt-10 pb-6 text-semibold">Cash or card, you earn Stars</h2>
                        <p className = "text-sm text-center md:text-base">No matter how you pay, you can earn Stars with your morning coffee. Those Stars add up to (really delicious) Rewards.</p>
                    </div>
                    ...
                    <Starperdollar line = "With Starbucks® Rewards Visa® Card" link1 = "https://www.starbucks.com/weblx/images/rewards/ways-to-pay/3A.png" number = "Up to 3" step1 = "Earn Stars even faster" content1 = {<>Earn Stars on all purchases you make with our <a href="#"
                      class="text-primary-500 underline ">credit card <ExternalLinkIcon className = "inline-flex w-4 h-4"/></a> opens in new window in and outside of Starbucks. Earn 1 Star per $1 when you digitally preload your Starbucks Card with your Starbucks® Rewards Visa® Card, and earn 2 Stars per $1 when you pay with that preloaded Starbucks Card.</>} ></Starperdollar>
                </div>
            </div>
        </div>
    );
